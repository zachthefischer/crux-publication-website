export const articleData = [
    {
        ...
        date: "Jan 1, 2022", 
        content: "In recent years, electric vehicles (EVs) have surged in popularity, revolutionizing the automotive industry. The push towards sustainable transportation is driven by growing environmental concerns and advancements in battery technology. EVs offer numerous benefits, including reduced greenhouse gas emissions, lower running costs, and less dependency on fossil fuels. Companies like Tesla, Nissan, and BMW are at the forefront of this movement, continuously innovating to increase the range and efficiency of their models. As charging infrastructure expands and battery costs decrease, the future of transportation looks increasingly electric."
    },
    {
        slug: "two", 
    ...
    },
    {
        ...
        author: "Jane Goodwont", 
        date: "Jan 1, 2022",
        content: "Mindfulness meditation has gained significant traction as a powerful tool for enhancing mental well-being. This practice involves focusing on the present moment, acknowledging and accepting one’s thoughts and feelings without judgment. Research has shown that regular mindfulness meditation can reduce stress, anxiety, and depression, while improving attention and emotional regulation. Incorporating just a few minutes of mindfulness into your daily routine can lead to a calmer, more centered life. Whether through guided sessions or self-practice, mindfulness offers a path to inner peace and resilience."
    },
    {
        slug: "four", 
        ...
        author: "Jane Goodwont", 
        date: "Jan 1, 2022",
        content: "Artificial Intelligence (AI) has evolved dramatically over the past few decades, transforming from a niche field into a cornerstone of modern technology. AI encompasses a range of technologies, including machine learning, neural networks, and natural language processing. Applications of AI are vast, from virtual assistants like Siri and Alexa to complex data analysis in healthcare and finance. AI systems can learn and adapt, making them invaluable for tasks that require pattern recognition and decision-making. As AI continues to advance, ethical considerations regarding privacy, bias, and job displacement remain critical discussions in the tech community."
    },
    {
        slug: "five", 
    ...
    // {
    //     slug: "six", 
    //     title: "Image Not Found: A Memoir The Sequel", 
    //     category: "Business",
    //     description: "The story of a young boy who lived in the forrest with rats and raccoons and a handful of birds.", 
    //     img:"https://www.shutterstock.com/image-vector/default-ui-image-placeholder-wireframes-600nw-1037719192.jpg", 
    //     author: "Jane Goodwont", 
